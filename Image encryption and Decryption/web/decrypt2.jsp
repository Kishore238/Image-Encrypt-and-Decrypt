...
<center>
    ...
    <form action="decrypt1.jsp" class="login100-form validate-form p-b-33 p-t-20 animated zoomIn" style="animation-duration: 1s; width:350px;position:relative;margin: auto;">
            ...
            <div class="wrap-input100 validate-input" data-validate = "Enter Part 3 Key">
                <input class="input100" type="text" name="pk3" placeholder="Enter Part 3 Key"  autocomplete="off">
