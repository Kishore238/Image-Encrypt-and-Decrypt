...
insert  into `decrypted`(`user`,`original`,`part1`,`part2`,`part3`) values ('krish','abc','krishencryp3.jpg','krishencryp3.jpg','krishencryp3.jpg');
...
insert  into `images`(`username`,`original`,`parta`,`partb`,`ori`) values ('krish','abc.jpg','abc0.jpg','abc1.jpg','abc');
...
insert  into `users`(`username`,`password`,`email`,`address`,`mobile`,`status`) values ('krish','Krish1234','moulalishaik225225@gmail.com','hyderabad','9985267418','accepted'),('shiva','shiva','shiva.1000projects@gmail.com','hyd','9632587410',NULL);
