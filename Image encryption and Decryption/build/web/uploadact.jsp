    ...
    System.out.println(splita[1]);
      ...
      String a = splita[0]+0+".jpg";
       String b = splita[0]+1+".jpg";
        ...
        File file = new File("C:\\Users\\chotu\\Documents\\NetBeansProjects\\Image encryption and Decryption\\web\\Gallery\\"+im+""); // I have bear.jpg in my working directory
        ...
        for (int i = 0; i < imgs.length; i++) {
            ImageIO.write(imgs[i], "jpg", new File("C:\\Users\\chotu\\Documents\\NetBeansProjects\\Image encryption and Decryption\\web\\Gallery\\"+splita[0]+"" + i + ".jpg"));
        }
